...
# 50 "usb_device_cdc.c" 2
# 66 "usb_device_cdc.c"
volatile unsigned char cdc_data_tx[64] __attribute__((address(0x240)));
volatile unsigned char cdc_data_rx[64] __attribute__((address(0x280)));
...
# 232 "usb_device_cdc.c"
            inPipes[0].info.bits.busy = 1;
            break;
# 257 "usb_device_cdc.c"
        default:
            break;
    }

}
# 291 "usb_device_cdc.c"
void CDCInitEP(void)
{
