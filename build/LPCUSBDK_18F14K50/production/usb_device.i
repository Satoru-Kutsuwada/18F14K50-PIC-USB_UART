...
volatile BDT_ENTRY BDT[((2 + 1) * 4)] __attribute__((address(0x200)));




volatile CTRL_TRF_SETUP SetupPkt __attribute__((address((0x200 +(((2 + 1) * 4)*4)))));
volatile uint8_t CtrlTrfData[8] __attribute__((address(((0x200 +(((2 + 1) * 4)*4)) + 8))));
# 215 "usb_device.c"
